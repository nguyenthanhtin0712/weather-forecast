...
<template>
    <div class="bg-custom-image bg-cover bg-top p-[10px] rounded-3xl flex items-center gap-2">
        <div class="mb-[10px] pr-2">
        ...
        <div class="pr-2">
            <div class="mb-[10px]">
                <span class="font-bold text-[white]"
                    >Longitude: {{ weatherInfo?.coord?.lon }}</span
                >
            </div>
            <div>
                <span class="font-bold text-[white]"
                    >Latitude: {{ weatherInfo?.coord?.lat }}</span
                >
            </div>
        </div>
    </div>
